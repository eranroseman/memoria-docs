...
> **Status: deferred (Phase 4).** The Hermes Kanban board and these export/aggregation steps do not exist in the starter vault yet — see [implementation-status.md](../implementation-status.md). This documents the intended mechanism that [card-schema.md](card-schema.md), [board-state](../dashboards/board-state.md), and [status-line.md](../obsidian-ui/status-line.md) reference.
...
- [dashboards/board-state.md](../dashboards/board-state.md), [dashboards/fleet-health.md](../dashboards/fleet-health.md), [obsidian-ui/status-line.md](../obsidian-ui/status-line.md) — the consumers.
