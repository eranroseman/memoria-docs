...
1. The [`reading-pipeline`](../../dashboards/reading-pipeline.md) / weekly review surfaces fleeting notes older than a few days.
...
- Note type: [vault/note-types.md](../../vault/note-types.md) — `fleeting-note`.
- Dashboard: [reading-pipeline.md](../../dashboards/reading-pipeline.md).
