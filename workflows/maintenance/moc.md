...
Create one when a cluster of claim-notes crosses the thresholds in [vault/linking-patterns.md](../../vault/linking-patterns.md): roughly ≥ 15–20 related claims, a recurring topic across ≥ 3 sources, or an orphan cluster the [`open-questions`](../../dashboards/open-questions.md) / drift surfaces keep flagging.
...
- Note type: [vault/note-types.md](../../vault/note-types.md) — `moc`.
