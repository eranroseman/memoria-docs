...
2. Any source whose status changed is flagged: its `pub_status` is updated and the [`contradictions`](../../dashboards/contradictions.md) / drift surfaces show claims that cite it.
...
- Field: [vault/frontmatter-schema.md](../../vault/frontmatter-schema.md) — `pub_status`, `superseded_by`.
- Decision: [ADR-22 claim supersession](../../decisions/22-claim-supersession.md).
