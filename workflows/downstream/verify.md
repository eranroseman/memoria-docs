...
3. The output lands as a `[!verification]` callout at the top of the draft (see [obsidian-ui/callouts.md](../../obsidian-ui/callouts.md)), summarizing total claims / traced / failed. The detailed per-claim report writes to `40-workbench/<project>/05-verification/<chapter>-<date>.md`.
