...
- Child MOC split at > 20 claim notes + > 10 source notes
...
- Operators consult the linking-patterns thresholds, not this ADR, when deciding MOC granularity.
...
- **Files affected:** [reference/linking-patterns.md](../../reference/linking-patterns.md#moc-creation-thresholds)
