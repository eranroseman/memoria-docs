...
| --- | --- | --- | --- |
| **Human** | `Cmd-1` | Left: [`index`](../dashboards/README.md). Main: empty / scratch. Right: [`board-state`](../dashboards/board-state.md). | Default. Open the vault, glance at health, close. Used 30 seconds at a time, multiple times per day. |
