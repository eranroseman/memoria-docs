...
Coarse access summary. The authoritative per-profile permissions live in [profiles/README.md](../profiles/README.md#lane-permissions-matrix); per-write policy is enforced by the [policy MCP](../architecture/policy-mcp.md) via the [lane-override files](../profiles/README.md#lane-override-files).
