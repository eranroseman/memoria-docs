...
The authoritative reference for vault linking discipline: link types, the full rule set, the expected cross-link graph by note type, MOC creation thresholds, and slug-collision resolution. The summary lives in [vault/README.md](../vault/README.md#linking-patterns); this document is the full reference.
