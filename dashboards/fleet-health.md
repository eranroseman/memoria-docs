...
- [glossary.md trust-score entry](../glossary.md#observability-and-verdicts) — the scoring formula and band thresholds

<!-- memoria-nav -->

---

[← Previous: drift-watch — design summary](drift-watch.md)

[Next: open-questions — design summary →](open-questions.md)
