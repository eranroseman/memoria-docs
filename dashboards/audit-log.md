...
- **Canonical-zone writes are surfaced explicitly.** Writes to `30-synthesis/01-claims/`, `30-synthesis/02-reference/`, `30-synthesis/03-moc/`, `50-deliverables/` are operationally significant — even when `allow`'d, they should be reviewable. The dashboard's "Canonical-zone writes" section surfaces them for periodic audit.
