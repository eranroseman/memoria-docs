...
- **The Reading & Processing workspace includes this dashboard.** Per [obsidian-ui/workspaces.md](../obsidian-ui/workspaces.md), discuss-queue is the left pane of the Cmd-2 workspace alongside [`reading-pipeline`](reading-pipeline.md). The workspace exists specifically to protect this discipline.
...
- [obsidian-ui/workspaces.md](../obsidian-ui/workspaces.md) — the Reading & Processing workspace this dashboard anchors
