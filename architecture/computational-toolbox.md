...
Used in: the Linter's structural detectors ([profiles/linter.md](../profiles/linter.md)), `cite-check` citation extraction ([profiles/verifier.md](../profiles/verifier.md)), schema validation, `ingest` type-detection dispatch table ([workflows/README.md workflow Ingest](../workflows/README.md)).
...
Used in: Mapper's `cluster-map`, `scope-project`, `gap-report` ([profiles/mapper.md](../profiles/mapper.md)).
...
Used in: Linter's graph-analyze command ([profiles/linter.md](../profiles/linter.md)), future propagation-debt enumeration ([roadmap/README.md](../roadmap/README.md)).
...
Used in (proposed): [3.2 tournament ranking for triage](../roadmap/future-directions.md#tournament-ranking-for-triage). Rationale in [why-computational-methods.md §"Candidate displacements"](why-computational-methods.md#candidate-displacements-where-the-llm-can-still-recede).
...
- [architecture/why-computational-methods.md](why-computational-methods.md) — the *why* this toolbox exists, the hybrid pattern, anti-patterns, cost and audit implications.
- [profiles/librarian.md](../profiles/librarian.md), [profiles/mapper.md](../profiles/mapper.md), [profiles/verifier.md](../profiles/verifier.md) — primary callers of the deterministic methods.
...
[← Previous: Computational methods: when Memoria uses LLMs vs classical methods](why-computational-methods.md)

[Next: Capability stack →](capability-stack.md)
