...
Folder permission matrix lives in [profiles/README.md](README.md#folder-permission-matrix); the runtime contract (full command list, deterministic/hybrid annotations per command, exit conditions) lives in the SOUL.md.
