...
Folder permission matrix lives in [profiles/README.md](README.md#folder-permission-matrix); the runtime contract lives in the SOUL.md. Notably narrow: five commands (`code`, `commit`, `revert`, `workspace`, `scaffold`), mostly thin wrappers around git and the code-note template.
