...
- Workflows: [ingest](../workflows/upstream/ingest.md), [find](../workflows/upstream/find.md), [classify](../workflows/upstream/classify.md), [zotero-capture](../workflows/upstream/zotero-capture.md)
- ADRs: [19 pre-ingest screening](../decisions/19-pre-ingest-screening.md), [17 retriever-scout profile](../decisions/17-retriever-scout-profile.md), [21 shared candidate frontmatter](../decisions/21-shared-candidate-frontmatter.md)
...
[← Previous: Profile commands (reference)](profile-commands.md)

[Next: Mapper — design summary →](mapper.md)
