...
Replace `<your-vault>` with the actual folder name the human cloned the starter vault into (per [on-disk-layout.md](../architecture/on-disk-layout.md#starter-vault-versioned-distributable), the vault root folder name is human-defined).
