...
The standard Memoria commands and their implementation patterns are in [command-palette.md](../../obsidian-ui/command-palette.md). QuickAdd doesn't ship a `data.json` template here — human setup varies enough that one standard config would constrain rather than help.
