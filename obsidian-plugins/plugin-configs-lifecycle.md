...
| [`omnisearch`](recommended/omnisearch.md) | Indexing depth and excluded folders are workflow-personal, not design-standard. [Librarian](../profiles/librarian.md) doesn't depend on it (search calls go through Hermes tools, not the Obsidian plugin). |
