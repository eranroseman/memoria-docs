...
- [`weekly-review`](../dashboards/weekly-review.md) surfaces evergreen claims ready to promote.
- A claim overturned later carries `superseded_by:` (its currency derives from that field) — see [decisions/22-claim-supersession.md](../decisions/22-claim-supersession.md).
