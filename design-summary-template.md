...
It is the same template-vs-instance split the rest of the repo uses ([vault/note-types.md](vault/note-types.md) vs `00-meta/03-templates/`; [obsidian-ui/design-system.md](obsidian-ui/design-system.md) vs the vault copy): the summary holds the *why*; the runtime artifact holds the *what*.
...
- **Extra section:** a **`## Permissions and commands`** pointer (to the lane-permission matrix in [profiles/README.md](profiles/README.md) and the SOUL.md) sits between *Design decisions* and *Related*.
