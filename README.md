...
| **(runtime, in starter vault)** | Runtime artifact | The 11 dashboards live at `00-meta/05-dashboards/` in the starter vault. The 15 note templates live at `00-meta/01-templates/`. The runtime SOUL.md prompts for the seven profiles live at `.memoria/profiles/memoria-<name>/SOUL.md`; the linter's structural detectors live at `.memoria/profiles/memoria-linter/M-detectors.md` alongside its SOUL.md. |
