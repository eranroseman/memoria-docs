...
| [obsidian-ui/](obsidian-ui/) | `README.md` (the Obsidian UI components) + per-component detail (`persistent.md` dashboards, `modal.md` workspaces, `inline.md` callouts, `ambient.md` status line) + `design-system.md` (visual-style template) + `command-palette.md` + `ui-discipline.md` (visual-style discipline). |
...
| [obsidian-plugins/](obsidian-plugins/) | `README.md` (priority-ordered overview) + per-plugin configuration split by lifecycle into `required/` (7, system breaks without them), `recommended/` (11, quality-of-life installs), `reference/` (3, held-knowledge / not in the install set), plus top-level `plugin-configs-lifecycle.md` (config governance). |
