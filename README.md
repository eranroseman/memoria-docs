...
- **Looking something up?** → [glossary.md](glossary.md), and the precise reference files inside each topic folder ([kanban-board/states.md](kanban-board/states.md), [kanban-board/card-schema.md](kanban-board/card-schema.md), [vault/frontmatter-schema.md](vault/frontmatter-schema.md), [vault/note-types.md](vault/note-types.md), [vault/linking-patterns.md](vault/linking-patterns.md), [profiles/profile-commands.md](profiles/profile-commands.md), [obsidian-ui/command-palette.md](obsidian-ui/command-palette.md), [architecture/policy-mcp.md](architecture/policy-mcp.md), [architecture/computational-toolbox.md](architecture/computational-toolbox.md), `obsidian-ui/*.md`, `dashboards/*.md`).
