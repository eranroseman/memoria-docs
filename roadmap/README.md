...
| [sync-and-coordination.md](sync-and-coordination.md) | The 5–15 second sync window; `.agent-lock` discipline; bib watcher |
| [skill-governance.md](skill-governance.md) | Skill state machine (intake → archived); registry; onboarding checklist; passthrough-to-dedicated graduation |
...
| [autonomy-progression.md](autonomy-progression.md) | The 12 within-boundary autonomy patterns from the [paper survey](../architecture/why-pattern-provenance.md), organized as a 5-layer dependency roadmap. Cross-cuts `future-directions.md`. |
| [success-metrics.md](success-metrics.md) | Time-from-capture-to-claim, promotion rate, review backlog, orphan rate, reuse rate |
| [decisions/](../decisions/) | 21 architecture decision records (ADRs); see [decisions/README.md](../decisions/README.md) for the index |
...
- **New MOC**: when a topic has ≥ 10 paper notes and ≥ 3 claim notes that share it.
