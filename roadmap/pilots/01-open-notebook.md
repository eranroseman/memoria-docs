...
[← Previous: Profile compilation: memoria-base and per-profile overrides](../profile-compilation.md)

[Next: Tutorial: Set up Memoria from zero →](../../tutorials/01-set-up-from-zero.md)
