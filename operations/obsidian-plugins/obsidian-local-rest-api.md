...
- `apiKey: "<token>"` — required when reachable from anything other than `127.0.0.1`. For Option C (VPS), this is non-optional. Mirrors the [fail-closed startup](../../01-architecture/control-plane.md#fail-closed-startup) discipline on the Hermes bridge side.
