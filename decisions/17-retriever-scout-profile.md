...
- At high discovery volume (e.g., the [discovery loop](../roadmap/future-directions.md) running at scale), Librarian's classifier and discovery scoring might compete for compute; if so, split then.
