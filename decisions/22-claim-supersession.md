...
- **Files affected:** [vault/frontmatter-schema.md](../vault/frontmatter-schema.md) (add the relation), [vault/templates.md](../vault/templates.md) + `00-meta/03-templates/claim-note.md`, the Linter's `M-detectors.md` (in the starter vault).
