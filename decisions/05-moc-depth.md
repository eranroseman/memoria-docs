...
**Retired.** The MOC creation thresholds in [linking-patterns.md](../vault/linking-patterns.md#moc-creation-thresholds) cover the granularity question with concrete numeric rules:
