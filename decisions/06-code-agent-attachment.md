...
- The same parallel-agents-with-shared-filesystem pattern generalizes to rendering agents ([open-design](../profiles/why-coder-external-agent.md#the-pattern-generalizes-external-rendering-agents)).
