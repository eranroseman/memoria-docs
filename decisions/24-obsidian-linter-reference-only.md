...
- **Files affected:** [obsidian-plugins/reference/obsidian-linter.md](../obsidian-plugins/reference/obsidian-linter.md) (moved from `recommended/`), [obsidian-plugins/README.md](../obsidian-plugins/README.md) (recommended 11→10, reference 3→4).
- **Profiles affected:** the [Linter](../profiles/linter.md) — owns the formatting/validation concern obsidian-linter would otherwise touch.
- **Related decisions:** the frontmatter namespace discipline this protects ([frontmatter-schema.md](../vault/frontmatter-schema.md)).
