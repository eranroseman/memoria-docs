...
| 5 | [MOC depth](05-moc-depth.md) | `retired` (2026-05) | Folded into [linking-patterns MOC thresholds](../vault/linking-patterns.md#moc-creation-thresholds). |
...
The index above is gap-free — every number 1–21 has a row — but the *directory* is not, and a reader browsing the files will notice the missing numbers. They are accounted for here so the gaps read as intentional, not as lost work:
